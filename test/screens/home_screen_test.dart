...
import 'package:explore_world/screens/home_screen.dart';
import 'package:explore_world/services/analytics_service.dart';
import 'package:explore_world/services/image_prefetch_service.dart';
...
void main() {
  ...
  setUp(() {
    ...
    ImagePrefetchService.resetForTest();
  });

  testWidgets('HomeScreen prefetches destination images once on initial load', (
    WidgetTester tester,
  ) async {
    int prefetchCount = 0;
    ImagePrefetchService.setTestPrefetchOverride((context, url) async {
      prefetchCount++;
    });
